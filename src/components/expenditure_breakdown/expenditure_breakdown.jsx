          ...
          <div className="col-12 col-sm-6 col-md-3">
            ...
            <div className="card-body d-flex justify-content-between align-items-end">
              <div className="card-number">
                ...
                <small><strong>{key.replace(/([A-Z])/g, " $1").charAt(0).toUpperCase() + key.replace(/([A-Z])/g, " $1").slice(1)}</strong></small>
              </div>
        ...
        Object.entries(data).slice(4).map(([key, val], i) => ((
          <div className="col-12 col-sm-6 col-md-3 mt-3">
            ...
            <div className="card-body d-flex justify-content-between align-items-end">
              <div className="card-number">
                <div className="h3 m-0">
                  {loading ? <LoadingDots/> : val.match(/^\d/) ? `₹ ${val}`:val}</div><small><strong>{key.replace(/([A-Z])/g, " $1").charAt(0).toUpperCase() + key.replace(/([A-Z])/g, " $1").slice(1)}
